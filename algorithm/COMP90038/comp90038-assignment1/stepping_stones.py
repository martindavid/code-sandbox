# Reference: http://blog.jupo.org/2012/04/06/topological-sorting-acyclic-directed-graphs/
...
pprint(topolgical_sort(graph_a))

top_sort = topolgical_sort(graph_a)
arr = {}
for v, edges in list(top_sort):
    arr[v] = 0
